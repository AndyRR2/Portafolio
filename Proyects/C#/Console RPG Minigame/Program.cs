    ...
    //Main Screen------------------------------------------------------------------------------------------------------------
        ...
        while (flag==true)
        {
            ...
            if (option==2){
                ...
                charact.SaveConstant(cons,"Constants");
                //establish constants-End----------------------------------------------------------------------------

            //continue saved game------------------------------------------------------------------------
            }else if(option==1){
                //for .EXE executed
                /*MainCh = charact.ReadMainCh(Path.Combine(AppContext.BaseDirectory, "Files", "Character"));
                EnemiesList = charact.ReadEnemy(Path.Combine(AppContext.BaseDirectory, "Files", "Enemies.json"));
                cons = charact.ReadConstant(Path.Combine(AppContext.BaseDirectory, "Files", "Constants.json"));*/
                //for Visual Studio console
                MainCh = charact.ReadMainCh("Files/Character.json");
                EnemiesList = charact.ReadEnemy("Files/Enemies.json");
                cons = charact.ReadConstant("Files/Constants.json");
        ...
        {
            File.Delete(Path.Combine(AppContext.BaseDirectory, "Files", "Character.json"));
            File.Delete(Path.Combine(AppContext.BaseDirectory, "Files", "Constants.json"));
            File.Delete(Path.Combine(AppContext.BaseDirectory, "Files", "Enemies.json"));
            File.Delete("Files/Constants.json"); 
            File.Delete("Files/Enemies.json");
            File.Delete("Files/Character.json");
        }*/
        //for Visual Studio console
        if (MainCh.Attributes.Health<=0 || EnemiesList.Count==0)
        {
